...
label ch20_main2:
    "Обычный будний день, похожий на любой другой."
    "По утрам, будучи окружённым идущими в школу парочками и компаниями друзей, я чувствовал себя паршивее всего."
    "Я всегда брёл в одиночестве."
    "И постоянно твердил себе, что однажды познакомлюсь с девушками или что-нибудь в том же духе..."
    "Но у меня совершенно нет мотивации вступать в какие бы то ни было клубы."
    "Я был вполне доволен своей ничем не примечательной жизнью, а свободное время проводил за играми и аниме."
    ...
    "Я робко последовал за Моникой по школьным коридорам и лестницам. В этом крыле, отданном под учебные классы третьегодок и клубы, я бывал нечасто."
