        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    textbutton _("Перевод") action SetField(persistent, "trans_ending", True)
                    textbutton _("Оригинал") action SetField(persistent, "trans_ending", False)
                    ...
                    if config.has_sound:
                        ...
                        hbox:
                            ...
                            if config.sample_sound:
                                textbutton _("Проверить") action Play("sound", config.sample_sound)
                    ...
                    if config.has_voice:
                        ...
                        hbox:
                            ...
                            if config.sample_voice:
                                textbutton _("Проверить") action Play("voice", config.sample_voice)
...
init -1 style name_frame is confirm_frame
init -1 style name_prompt is gui_prompt
init -1 style name_prompt_text is confirm_prompt_text
init -1 style name_button is confirm_button
init -1 style name_button_text is confirm_button_text

init -1 style name_frame:
