...
label ch40_main:
    ...
    mc "Ну, да..."
    mc "Я всегда считал, что это нечто само собой разумеющееся."
    ...
    "Я собирался было выдать свою излюбленную фразу, что клубы меня не интересуют..."
    ...
    "Сложив вещи в портфель, я собираю в кулак всю свою мотивацию и встаю."
    mc "Что ж, посмотрим..."
    stop music fadeout 2.0

    scene bg corridor
    with wipeleft_scene
    "Я вспоминаю номер комнаты, который видел на листовке."
    "И не спеша следую по школьным коридорам и лестницам. В этом крыле, отданном под учебные классы третьегодок и клубы, я бываю нечасто."
    "Не успеваю я опомниться, как уже стою перед нужной комнатой."
    ...
    "По сравнению с ней, девушка по имени Нацуки, вопреки своему росту, кажется куда увереннее в себе."
    ...
    "Глаза Саёри загораются."
    show sayori at f32
    s 1n "...Не может быть."
    s 1s "Не может быть!"
    show sayori at hf32
    s 4s "А-а-ах-ха-ха!"
    "Она обхватывает меня руками и прыгает от счастья."
    show sayori at t32
    mc "Э-эй!"
    show natsuki at f31
    n 3y "Э-хе-хе."
    ...
    show natsuki at t22
    "Первой кекс берёт Саёри, я следую её примеру."
    show sayori at f21
    s 4q "Как фкуфно!"
    show sayori at t21
    ...
    hide natsuki
    "Пока Нацуки принимает комплименты, Юри возвращается к столу, неся в руках чайный сервиз."
    ...
    s "М-может..."
    "Почувствовав нарастающее напряжение, Саёри вскакивает."
    ...
    mc "Я не прочь заняться этим, если буду это делать не один."
    ...
    y 2v "Я... не понимаю..."
    y "..."
    "Юри задумывается, её лицо принимает виноватое выражение."
    ...
    n 2c "Доверься мне, и я подберу то, что действительно тебе понравится."
    show natsuki at t21
    show yuri at f22
    y 1m "Взаимно..."
    ...
    hide natsuki
    hide yuri
    "Нацуки и Юри начинают убирать со стола."
    ...
    s 1x "А раз уж к нам присоединился ты, у нас будет ещё веселее."
    stop music fadeout 2.0
    s 1a "Слушай, [player]..."
