...
screen poem(currentpoem, paper="paper"):
    ...
    vbox:
        add paper
    viewport id "vp":
        child_size (gui.poem_child_size, None)
        mousewheel True
        draggable True
        has vbox
        null height 10
...
style poem_viewport:
    xanchor 0
    xsize gui.poem_viewport_xsize
    xpos gui.poem_viewport_xpos
style poem_vbar is vscrollbar:
    xpos gui.poem_vbar_xpos
    yalign 0.5
...
style yuri_text:
    ...
    size gui.yuri_text_size
    color "#000"
    outlines []

style yuri_text_2:
    font "gui/font/Katherine_Plus.ttf"
    size gui.yuri_text_2_size
    color "#000"
    outlines []

style yuri_text_3:
    font "gui/font/ShlapakScript.otf"
    size gui.yuri_text_3_size
    color "#000"
    outlines []
    kerning -2.2
    justify True
...
style sayori_text:
    ...
    size gui.sayori_text_size
    color "#000"
    line_spacing 10
    outlines []

style sayori_text_2:
    font "gui/font/Scotch.ttf"
    size gui.sayori_text_2_size
    color "#000"
    outlines []

style monika_text:
    font "gui/font/Adventure.ttf"
    size gui.monika_text_size
    line_spacing 10
    color "#000"
    outlines []
...
label showpoem(poem=None, music=True, track=None, revert_music=True, img=None, where=i11, paper=None):
    ...
    if not renpy.variant("pc"):
        show expression "gui/poem_dismiss_big_ru.png" as poem_dismiss:
            xalign 0.997 yalign 0.995
    elif not persistent.first_poem:
