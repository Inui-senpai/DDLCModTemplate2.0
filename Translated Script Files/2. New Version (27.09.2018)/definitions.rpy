...
define persistent.allow_slang = False
define persistent.allow_username = False
define persistent.allow_joke = False
define persistent.ext_pref = False
...
init python:
    ...
    if renpy.variant("android"):
        user_dir = os.environ.get["ANDROID_PUBLIC"]
    else:
        user_dir = config.basedir
    if not os.path.exists(user_dir + "/characters/"):
        try: os.mkdir(user_dir + "/characters/")
        except: pass
...
image bg notebook = "bg/notebook_ru.png"
image bg notebook-glitch = "bg/notebook-glitch_ru.png"
