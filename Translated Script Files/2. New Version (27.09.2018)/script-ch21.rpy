...
label ch21_main:
    ...
    mc "Может, это прозвучит странно, но я держу своё слово."
    show monika zorder 1 at thide
    hide monika
    "И вот я снова в литературном клубе."
    "Я пришёл последним, так что в клубе уже вовсю бурлит деятельность."
    ...
    hide natsuki
    "Уничтоженная одной репликой, Нацуки угрюмо плюхается на свой стул."
    ...
    mc "Поэтому, раз ты предлагаешь, мне кажется правильным заняться чем-то подобным."
    y 4b "П-подожди..."
    y "Я ведь не имела в виду ничего такого!"
    y "У-ум..."
    ...
    "Юри вытаскивает из своего портфеля книгу."
    ...
    "Я ожидал, что, после того как все рассядутся, Моника пойдёт по плану мероприятий клуба."
    "Но, похоже, ошибся."
    "Юри с головой погрузилась в чтение."
    "У неё такое сосредоточенное выражение лица, будто она весь день этого ждала."
    "Нацуки же копается в кладовке."
...
label ch21_end:
    ...
    "В другом конце комнаты Моника пишет что-то в тетради."
    "Мой взгляд останавливается на Юри с Нацуки."
    show yuri 2g zorder 2 at t21
    show natsuki 1g zorder 2 at t22
    "Девушки робко обмениваются стихами."
    show yuri 2i zorder 2 at t21
    "Когда они начинают читать, я с интересом наблюдаю, как изменяются выражения их лиц."
    "Нацуки недовольно хмурит брови."
    "В то же время Юри печально улыбается."
    ...
    show natsuki zorder 3 at f22
    n 2c "О, нет, ничего."
    "Нацуки пренебрежительно одной рукой кладёт тетрадь со стихом на стол."
    ...
    show natsuki zorder 3 at f22
    n 5x "Хмф."
    n "Если бы мне были нужны советы, я спросила бы того, кому мой стих понравился."
    ...
    y "Он даже сказал, что впечатлён."
    stop music fadeout 1.0
    "Нацуки резко встаёт."
    show yuri zorder 2 at t21
    show natsuki zorder 3 at f22
    n 4y "О, правда?"
    n "Я и не представляла, что ты так озабочена тем, чтобы впечатлить нашего нового члена, Юри."
    play music t7a
    show natsuki zorder 2 at t22
    show yuri zorder 3 at f21
    y 1n "Э-э-э?!"
    ...
    y 1o "У-у..."
    y "Ты... Ты просто..."
    "Юри тоже поднимается со стула."
    y 2r "Может, ты просто завидуешь, что [player] мои советы ценит больше твоих?!"
    show yuri zorder 2 at t21
    show natsuki zorder 3 at f22
    n 1e "Неужели! С чего это ты решила, что {i}мои{/i} он ценит меньше?"
    ...
    y "Думаешь, что можешь компенсировать свой ядовитый характер яркими тряпками и милым поведением?"
    ...
    if persistent.allow_slang:
        y 3r "У тебя, блядь, что, совсем крыша поехала?!"
    else:
    ...
    if persistent.allow_joke:
        if (not persistent.allow_slang or renpy.random.randint(0, 1) == 0):
            n "Уверена, он после этого втрескается в тебя по самые пятки!"
        else:
            n "Уверена, он после этого полюбит тебя по самые гланды!"
    else:
        n "Уверена, он после этого по уши в тебя втрескается!"
    show natsuki zorder 2 at t22
    show yuri zorder 3 at f21
    y 3n "А-ах—!"
    show yuri zorder 2 at t21
    "Внезапно Юри поворачивается ко мне, словно только сейчас заметив моё присутствие."
    show yuri zorder 3 at f21
    y 2n "[player]!.."
    ...
    "{cps=*2}Я ведь вообще не разбираюсь в поэзии...{/cps}{nw}"
    "{cps=*2}Но, какую из девушек ни поддержу, я сразу же заслужу её расположение!{/cps}{nw}"
    ...
    m 1e "Думаю, лучше нам держаться подальше от их склок..."
    m "Вернёмся внутрь, когда они перестанут голосить."
    m 5 "А-ха-ха..."
    m "Никудышный из меня президент, да?"
    m 1m "Не могу справиться даже с членами собственного клуба..."
    ...
    show monika zorder 1 at thide
    hide monika
    "Тут вдруг из класса выскакивает Нацуки."
    show natsuki 12h zorder 2 at t11
    n "..."
    show natsuki 12f at lhide
    $ pause(0.75)
    hide natsuki
    "Она быстро убегает прочь."
    ...
    y "Не это хотела сказать..."
    y "Не это хотела сказать..."
    "Юри сидит за партой и раскачивается взад-вперёд, закрыв лицо руками."
    mc "Юри?.."
    ...
    "Или сказала."
    y "[player]."
    y "Пожалуйста, не надо думать обо мне плохо."
    y "Пожалуйста!"
    y "Я не такая!"
    ...
    m "Как бы то ни было, собрание закончено, так что, если хочешь, можешь идти домой."
    show monika zorder 2 at t31
    show yuri zorder 3 at f32
    y 4a "..."
    show yuri zorder 2 at t32
    "Мне кажется, что Юри хочет что-то сказать."
    "Но она продолжает смотреть на Монику."
    show yuri zorder 3 at f32
