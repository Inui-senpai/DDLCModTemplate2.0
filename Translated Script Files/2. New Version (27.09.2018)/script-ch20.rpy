...
label ch20_main2:
    "Обыкновенный будний день, похожий на любой другой."
    "По утрам, в окружении идущих в школу парочек и компаний друзей, я чувствую себя паршивее всего."
    "Я всегда бреду в одиночестве."
    ...
    "Конечно, есть клуб любителей аниме, но девушек в нём всё равно нет..."
    ...
    "Кроме того, в большинстве из них, наверное, слишком высокие требования, чтобы мне захотелось с ними связываться."
    ...
    m 1a "О, просто ищу кое-что для клуба."
    ...
    m "В литературном клубе можно заниматься чем угодно: читать, писать рассказы или стихи..."
    ...
    "Хм-м..."
    m 1a "Слушай, [player]..."
    m "Может ли быть, что... ты всё ещё ищешь, в какой клуб вступить?"
    mc "А..."
    mc "Думаю, в какой-то мере, но..."
    m "В таком случае..."
    m 5 "Есть ли шанс, что ты окажешь мне небольшую услугу?"
    ...
    m 1b "Ты такой душка, [player], ты знаешь это?"
    mc "С-скажешь тоже..."
    m 1a "Ну что, пойдём тогда?"
    m "Поищу канцелярские принадлежности в другой раз. Ты гораздо важнее."
    ...
    "Сегодняшний день увековечен тем, что я продал душу Монике и её неотразимой улыбке."
    "Я робко следую за Моникой по школьным коридорам и лестницам. В этом крыле, отданном под учебные классы третьегодок и клубы, я бываю нечасто."
    "Преисполненная энтузиазмом, Моника распахивает дверь класса."
    ...
    show monika zorder 3 at f31
    m 1a "В общем, я зашла в один класс за принадлежностями, а там был [player]. Мы разговорились, и он решил заглянуть к нам в клуб."
    m "Разве не здорово?"
    ...
    "Юри проходит в угол комнаты и открывает кладовку."
    "Тем временем Моника и Нацуки усаживаются друг против друга."
    "Чувствуя себя всё так же неуютно, я сажусь рядом с Моникой."
    ...
    mc "Пусть Моника и убедила меня зайти, я никакого решения ещё не принял."
    mc "Я всё ещё хочу посмотреть другие клубы и... м-м-м..."
    show monika 1g
    show natsuki 4g
    show yuri 2e
    "Я теряю ход мысли."
    "Все три девушки смотрят на меня отрешёнными взглядами."
    show monika at s33
    m 1p "Н-но..."
    show yuri at s32
    ...
    n 5s "Хмф."
    mc "А?.."
    "Девушки обмениваются взглядами с Моникой, и она поворачивается ко мне."
    show monika zorder 3 at f33
    ...
    "К тому же, если написание стихов – та цена, которую мне надо заплатить, чтобы каждый день проводить в компании трёх красавиц..."
    mc "...Так."
    mc "Ладно, я решил."
    ...
    "Девушки тем временем продолжают болтать, а Юри убирает чайный сервиз."
    ...
    "Я выхожу из клубной комнаты и направляюсь домой."
    "Всю дорогу мои мысли крутятся вокруг трёх девушек:"
