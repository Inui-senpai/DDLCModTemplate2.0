...
# Этот файл управляет логикой концовки DDLC и вашей модификации!
...
# Эти определения изображений показывают неувиденные сценки в игре, а затем
# происходит их «удаление» из титров.
...
# Логотип DDLC с применёнными к нему трансформациями.
image credits_logo:
    "gui/logo.png"
    truecenter
...
# Логотип Team Salvato с применёнными к нему трансформациями.
image credits_ts:
...
label credits2:
    ...
    label postcredits_loop:
        ...
        # Эта команда вызова экрана выводит на экран ложное окно с сообщением
        # о повреждении/отсутствии файлов и единственной кнопкой, которая закрывает игру.
        call screen dialog(_("Ошибка: некоторые файлы повреждены или отсутствуют.\nПереустановите игру."), Quit(confirm=False))
        return
