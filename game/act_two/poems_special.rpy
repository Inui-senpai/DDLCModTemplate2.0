...
image poem_special4 = "poem_special/poem_special4.png" # Памятка о порезе
...
image poem_special10 = "poem_special/poem_special10.png" # Сходить к психотерапевту
...
# Чтобы показать такое стихотворение, используйте «call poem_special(X)», где X –
# номер стихотворения в списке выше.
