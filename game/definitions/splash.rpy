...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        "«[config.name!t]» является фанатской модификацией к игре «Литературный клуб \"Тук-тук!\"», которая никак не связана с Team Salvato."
        ...
        menu:
            "Играя в «[config.name!t]», вы соглашаетесь с тем, что прошли полностью игру «Литературный клуб \"Тук-тук!\"» и готовы к любым спойлерам."
            "Я согласен.":
                $ persistent.first_run = True
