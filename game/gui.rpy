...
# Этот файл содержит определения координат, цветов, путей и прочих параметров
# интерфейса DDLC.

# Задаёт приоритет инициализации для ВСЕХ объявлений в этом файле
init offset = -2
...
## Звуки интерфейса
# Эти переменные задают звуковое сопровождение элементов интерфейса игры.
define gui.hover_sound = "gui/sfx/hover.ogg" # звук наведения
define gui.activate_sound = "gui/sfx/select.ogg" # звук нажатия
define gui.activate_sound_glitch = "gui/sfx/select_glitch.ogg" # глючный звук нажатия
...
# Цвет, используемый текстовой кнопкой, когда она не выбрана и не наведена.
define gui.idle_color = '#aaaaaa'

# small_color используется маленьким текстом, который должен быть ярче/темнее
# для того, чтобы выделяться.
define gui.idle_small_color = '#333'

# Цвет, используемый кнопками и панелями, когда они наведены.
...
# Цвета, используемые для незаполненных частей панелей. Они
...
# Шрифты и их размеры
# Эти переменные задают шрифты и их размеры для текста в DDLC.
...
# Размер заголовка игры (в правом нижнем углу).
...
# Высота диалогового окна, содержащего диалог.
define gui.textbox_height = 182

# Местоположение диалогового окна по вертикали экрана.
# 0.0 – верх, 0.5 – центр и 1.0 – низ.
define gui.textbox_yalign = 0.99

# Местоположение имени говорящего персонажа относительно диалогового окна.
...
# Границы окна, содержащего имя персонажа, в порядке слева, сверху, справа, снизу.
define gui.namebox_borders = Borders(5, 5, 5, 2)

# Управляет отображением рамки окна, содержащего имя персонажа.
define gui.namebox_tile = False

# Размещение диалога относительно диалогового окна.
...
# Если стоит None, Ren'Py самостоятельно рассчитает размер.
